package com.silencedut.knowweather.ui.calendar;
...
public class CalendarCustomView extends DayView {
     ...
     */
    public CalendarCustomView(Context context, int layoutResource) {
    ...
    public IDayRenderer copy() {
        return new CalendarCustomView(context, layoutResource);
    }
}
